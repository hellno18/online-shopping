...
<div class="top-brands">
	<div class="container">
		...
		<div class="agile_top_brands_grids">
			<?php $get=$connectdb->query("SELECT * FROM product WHERE category_product = 'mens' AND condition_product='new' ORDER BY id_product DESC limit 12");?>
			...
			<div class="agile_top_brand_left_grid">
				...
				<figure>
					...
					<div class="snipcart-thumb">
						...
						<h4><?php echo number_format($row['price_product'],2,",",".")." Yen";?> <span>$10.00</span></h4>
					</div>
